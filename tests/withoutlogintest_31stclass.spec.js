...
import employeedetails from "../testdata/addemployee_24thclass.json"

test.describe('validate Orange HRM Login functionality',()=>{
...
test('Add job tite',{tag:"@smoke"}, async ({ page }) => {
