...
test.describe('Automation - Working With Elements', () => {
    ...
    test('Upload Multiple files and assert', async ({ page }) => {
        ...
        await page.locator('input[type="file"]').setInputFiles(['./testdata/files/IMG_20181019_100235.jpg', './testdata/files/IMG.jpg'])

        await expect(page.locator('p.name').nth(0)).toHaveText('IMG_20181019_100235.jpg')
        await expect(page.locator('p.name').nth(1)).toHaveText('IMG.jpg')
